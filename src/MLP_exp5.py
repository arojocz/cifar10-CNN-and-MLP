...
class MLP(nn.Module):
    """
    MLP Experiment 1 (Baseline): 1 hidden layers (116
    """
    def __init__(self, input_features=3072, num_classes=10):
        super(MLP, self).__init__()
        self.flatten = nn.Flatten()
        self.layers = nn.Sequential(
            nn.Linear(input_features, 116),
            nn.ReLU(),
...
if __name__ == '__main__':
    ...
    best_model_path = 'best_mlp_model_exp5.pth' # Unique model name
