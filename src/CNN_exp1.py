...
class SimpleCNN(nn.Module):
    """
    CNN Experiment 1 (Baseline): 3 blocks (32, 64, 128 filters)
    Classifier: 128 neurons
    """
    def __init__(self, num_classes=10):
        ...
        self.classifier = nn.Sequential(
            nn.Flatten(),
            nn.Linear(128 * 4 * 4, 128), # 2048 -> 128
            nn.BatchNorm1d(128),
            nn.ReLU(),
            nn.Dropout(0.2), 
...
if __name__ == '__main__':
    ...
    best_model_path = 'best_cnn_model_exp1.pth' # Unique model name
    ...
    results_filename = 'results_CNN_exp1.pth' 
    
    print(f"Saving results to '{results_filename}'...")

    results_to_save = {
        'experiment_name': 'CNN Exp 1',
        'model_architecture': '3-Block CNN (32-64-128)',
        'history': history,
