...
if __name__ == '__main__':
    ...
    best_model_path = 'best_mlp_model_exp2.pth' # Unique model name
    ...
    results_filename = 'results_MLP_exp2.pth'
    
    print(f"Saving results to '{results_filename}'...")

    results_to_save = {
        'experiment_name': 'MLP Exp 2 (no augmentation)',
